...
b_d.cut(lon_min=-1, lon_max=-0.95, lat_min=37.55, lat_max=37.6)
b_d.ds.elevation.values *= -1
b_d.save_nc(fname_save=r'D:\Development\repos\gestor_batimetrico\Example\00_BATI_CARTAGENA_SAMOA2_ETRS89_UTM_30N_cut.nc')
